...
1. Manny - sticky nav bar (form for name, school) no longer sticking - this has since been fixed
...
Open items:
1. Weather Widget and API requirement, does localstorage count, waiting on answer from Lee. - Lee said no - E
2. James, my google fonts returned an error when I tried to validate. When I tried to copy yours, I realized you were using a different font family. Let me know how you want to move forward on this. I might need to update my google fonts code anyway. - Nevermind! I didn't realize this was for the ad only - E
